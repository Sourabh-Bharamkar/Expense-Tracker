...
async function login(e) {
    ...
    try {
        ...
        const response = await axios.post('http://34.201.14.35:3000/user/login/verify', userDetails)
...
async function recoverPassword(e) {
    ...
    try {
        ...
        const response = await axios.post('http://34.201.14.35:3000/user/password/forgot-password', { email: email })
        const forgotPassworddModal = document.getElementById('forgot-password-modal')
